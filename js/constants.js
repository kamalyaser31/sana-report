...
const TEACHERS = ["محمد نبيل", "أسماء علي", "فاطمة إبراهيم", "رجاء لطفي", "فاطمة عزت", "سمية فتحي", "سارة العدل"];
...
const VISIBILITY_FIELD_KEYS = ['تسميع', 'مراجعة_قديمة', 'ماضي_قريب', 'حفظ', 'مراجعة', 'ماضي_قريب_جديد', 'ملاحظات', 'وسام', 'quran_picker'];
